...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { message, success, error, jwtToken } = response.data;
      ...
      <div className="signup-Container">
        <form onSubmit={handleSubmit}>
          ...
          <TextField
            ...
            style={{ marginBottom: "20px", width: "90%" }}
          />
          <FormControl sx={{ width: "90%", mb: "20px" }} variant="outlined">
          ...
          <Box display="flex" justifyContent="center" gap={2}>
            ...
            <IconButton href="https://twitter.com" style={{ color: "#1DA1F2" }}>
              <Twitter fontSize="large" />
            </IconButton>
            <IconButton href="https://github.com" style={{ color: "#333" }}>
